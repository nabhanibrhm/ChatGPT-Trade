...
[ Snapshot ]
Cash Balance: Rp{cash:,.2f}
Total Equity: Rp{total_equity:,.2f}
...
Only recommend 2 trades you are confident about. If no trades are recommended, use an empty trades array."""
...
def run_automated_trading(api_key: str, model: str = "o3", data_dir: str = "Start Your Own", dry_run: bool = False):
    ...
    if portfolio_file.exists():
        ...
        for col in ["ticker", "shares", "stop_loss", "buy_price", "cost_basis"]:
